<?php $this->load->view('readerAll/header'); ?>
...
<div class="mainWrapper">
	...
	<div class="image-container-manga" id="imageContainer">
		<?php foreach ($detail as $key) {
				echo '<img id="mangaimg" class="CurImage nextBtn" src="'.base_url().'./assets/images/manga/'.$title."/".$title." ".$chap."/".$key->image.'">';
				echo '<br><br>';
		} ?>
	</div>
...
<?php $this->load->view('readerAll/footer'); ?>