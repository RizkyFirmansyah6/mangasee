...
<html lang="en">
	...
	<body>
		<nav class="navbar navbar-fixed-top device-fixed-height" style="z-index: 2147483647; top: 0px;">
			<div class="container">
				...
				<div id="navbar" class="collapse navbar-collapse device-fixed-width">
					<ul class="nav navbar-nav navbar-right">
						<li>
							<a class="wholeChapter" readmode="WholeChapter" style="cursor:pointer;padding-top: 15px;padding-bottom: 15px" onclick="changeMode();">
								<span class="fa fa-file-o"></span> Single Page
							</a>
						</li>
						<li>
